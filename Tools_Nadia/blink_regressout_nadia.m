function [newpupil] = blink_regressout_nadia(pupildata, fsample, blinksmp, saccsmp,   plotme, addBackSlowDrift,subject)
...
% Anne Urai, 2016
% initialize settings
addpath ('/DATA2/BLB_EXP_201902_SGMem2/BLB_BackUp_files/Protocols/Analysis_Scripts/Pupillometry/Tools-master_AU/eye');
...
[b,a]      = butter(3, 0.05 / fsample, 'high');
...
blinkIRF = doublegamma_fit_blink(x, deconvolvedPupil(:, 1));
saccIRF  = doublegamma_fit_sacc(x, deconvolvedPupil(:, 2));
