function [newpupil, newblinksmp, nanIdx, dat] = blink_interpolate1(data, blinksmp, plotme, subject)
% interpolates blinks and missing data
% based on Anne Urai, 2016
...
padding         = 0.1; % how long before and after do we want to pad?
